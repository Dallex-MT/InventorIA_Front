...
export default function Page500() {
	...
	return (
		<>
			<Helmet>
				<title>
					{t("sys.nav.error.500")} - {t("sys.nav.error.internal_server_error")}
				</title>
			</Helmet>
				...
				<MotionContainer className="flex flex-col items-center justify-center px-2">
					<m.div variants={varBounce().in}>
						<Title as="h3" className="text-center">
							{t("sys.nav.error.internal_server_error")}
						</Title>
					</m.div>

					<m.div variants={varBounce().in}>
						<Text variant="caption" color="secondary" className="text-center">
							{t("sys.nav.error.internal_server_error_description")}
						</Text>
					</m.div>
					...
					<NavLink to={HOMEPAGE}>
						<Button size="lg">{t("sys.nav.error.go_home")}</Button>
					</NavLink>
				</MotionContainer>
			</div>
		</>
